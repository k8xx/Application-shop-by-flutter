...
import 'package:shop1/providers/cart.dart';
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        errorMessage = 'This email address is alreadynin use.';
      ...
      const errorMessage = 'ould not authenticate you. Please try again later.';
      _showErrorDialog(errorMessage);
    }
    setState(() {
      _isLoading = false;
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                FlatButton(
                  child: Text(
                    'Create ${_authMode == AuthMode.Login ? '' : 'Login'} Account?',
                  ),
